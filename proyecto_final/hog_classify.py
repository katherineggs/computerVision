...
def loadModel(path="SVM"):
    ...
    """
    with open('modelPkl'+str(path) , 'rb') as files:
...
def runDetector(path, model="SVM"):
    ...
    print("Images processed " + str(imgIndex+1))
    return "Images processed " + str(names)
...
if __name__ == '__main__':
    ...
    if args.model == "ABC":
        print("The model trained is ABC.\n")
        print("Metrics")
        print("-------------------------------")
        print("Precision score - 0.945187")
        print("Recall score - 0.933949")    
        print("")    

    runDetector(args.path, args.model)